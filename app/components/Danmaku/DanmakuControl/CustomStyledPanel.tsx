...
export default function CustomStyledPanel(props: { t: TFunction }) {
  const { t } = props;
    ...
    <>
      ...
      <div className="danmaku-adjust-row flex">
        ...
        <input
          ...
          onBlur={e => StyledDao.save(StyledDaoNS.UserWrapper, e.target.value)}
      ...
      <div className="danmaku-adjust-row flex">
        ...
        <input
          ...
          onBlur={e => StyledDao.save(StyledDaoNS.ContentWrapper, e.target.value)}
          className="link-input t-center v-middle border-box level-input custom-style"
        />
      </div>
    </>
