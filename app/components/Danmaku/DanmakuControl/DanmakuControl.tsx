    ...
    <div id="danmakuControlOuter">
      ...
      <div id="danmakuControl" className="icon-right-part superChat">
        ...
        <Tooltip
          ...
          trigger="click"
          overlay={<SettingContent {...props} handleUpdateConfig={handleUpdateConfig} resetConfig={resetConfig} />}
        >
...
function SettingContent(props: {
  ...
  const { t, config, handleUpdateConfig, resetConfig } = props;
...
function EffectBlock(props: {
  ...
  const { t, config, clearSCMessage, handleUpdateConfig } = props;
...
function DanmakuBlock(props: {
  ...
  const { t, config, updateConfig, handleUpdateConfig } = props;
...
export default connect(mapStateToProps, mapDispatchToProps)(DanmakuControl);
